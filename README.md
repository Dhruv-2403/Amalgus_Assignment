...
This prototype was built with assistance from **Cascade AI** (AI coding assistant). Here's how AI helped:

### What Cascade AI Assisted With:
1. **Rapid Prototyping**: Generated the complete project structure, React components, and matching engine in a single session
2. **Code Generation**: Wrote the TF-IDF implementation, React UI components, and Tailwind styling efficiently
3. **Product Data**: Created 15 realistic glass industry products with detailed specifications
4. **Optimization**: Suggested using TF-IDF instead of external embedding APIs to keep the prototype self-contained and fast
5. **Documentation**: Helped structure the README and explain the matching algorithm
...
├── src/
│   ├── data/
│   │   └── products.js          # 15 mock glass products
│   ├── utils/
│   │   └── matchingEngine.js    # TF-IDF + cosine similarity implementation
...
This is a prototype built for the AmalGus assignment.
